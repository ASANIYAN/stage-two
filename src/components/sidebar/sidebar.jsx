...
const SideBar = () => {
    ...
    return (
        <section className="w-[226px] border border-color11 rounded-r-[45px] py-5">
                ...
                <ul className="space-y-2.5 font-semibold text-color6">
                    { navigations.map((navigation) => {
                        ...
                        return (
                            <Fragment key={name}>
                                <li 
                                    className={`pl-12 py-4 text-lg flex items-center gap-2 
            ...
            <section className="rounded-[20px] border border-color7 bg-color8 w-[170px] mx-auto px-2.5 pb-2 pt-10 flex flex-col gap-2">
