...
const Hero = () => {
    return (
        <section className="max-w-[400px] w-full text-white">
            <h1 className="font-semibold text-3xl sm:text-4xl lg:text-5xl"> John Wick 3: Parabellum </h1>
            
            <section className="flex items-center gap-2.5 mt-4">
            ...
            <p className="font-normal text-sm mt-4 w-full max-w-[300px]">
